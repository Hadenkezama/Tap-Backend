...
if(!catagorie){
  ...
  const query = 'UPDATE coolers_ciders_catagories SET cooler_cider WHERE catagorie_id = ?'
...
const deleteOne = (req, res) => {
  ...
  if(!isNaN(del)){
    connection.query(`delete from coolers_ciders_catagories where catagorie_id = ${del}`, 
    (err, result) => {
